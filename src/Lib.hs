...
someFunc = do
        ...
        interpreter <- (CT.writePascalFile) "./app/resources/code.pas" exampleVars exampleLiterals exampleLetStatements exampleLambdaExp exampleConditionExpr exampleThenExpr
        print interpreter